...
from .views import CategoriaCreateView, CategoriaDeleteView, CategoriaListView, CategoriaUpdateView, ProdutoCreateView, ProdutoDeleteView, ProdutoListView, ProdutoUpdateView
...
urlpatterns = [
    ...
    path('categorias/novo/', ProdutoCreateView.as_view(), name='produto_create'),
